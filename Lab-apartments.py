...
"""Finally, let’s finish up with some simple lambda functions held in variables. You will get warnings here—for this 
assignment, you should ignore those. plus_one_hundred Write a lambda function that adds 100 to any given number 
square_num Write a lambda function that squares any given number concatenate Write a lambda function that 
concatenates “- “ before any string divide_by_three Write a lambda function that divides any number by 3"""
